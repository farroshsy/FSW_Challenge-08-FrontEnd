            ...
            <div className="card mb-3">
              <div className="row">
                <div className="col-lg-3 m-auto text-center card-actor">
                  <img
                    src="asset/gambar/img_photo-1.png"
                ...
                <div className="col-lg-9">
                  <div className="card-body">
                    <div className="font-10">
                      <i className="uis uis-star text-success" />
                      <i className="uis uis-star text-success" />
                      <i className="uis uis-star text-success" />
                      <i className="uis uis-star text-success" />
                      <i className="uis uis-star text-success" />
          ...
          <div className="item">
            <div className="card mb-3">
              <div className="row">
                <div className="col-lg-3 m-auto text-center card-actor">
                  <img
                    src="asset/gambar/img_photo-2.png"
                    className="img-fluid mx-auto d-block rounded-circle"
                    alt="photo1"
                    height="10"
                  />
              ...
              <div className="row">
                ...
                <div className="col-lg-9">
                  <div className="card-body">
                    ...
                    <p className="card-text">
                      <q>
                        TLorem ipsum dolor sit, amet consectetur adipisicing elit. Similique,
                        molestiae. Doloribus architecto animi non ipsum omnis quae, dicta
                        nobis nam ducimus dolores tempora expedita magnam, voluptate fugiat
                        culpa aspernatur delectus.
                      </q>
